...
const Description = () => {
  return (
    ...
    viewport={{once:true}}
    className="flex flex-col items-center justify-center my-24 p-6 md:mx-28">
      ...
      <div className="flex flex-col gap-5 md:gap-14 md:flex-row items-center">
        ...
        />
        <div>
          <h2 className="text-3xl font-medium max-w-lg mb-4">Introducing tha AI-Powered Text to image Generator</h2>
          ...
          <p className="text-gray-600">
            ...
            design and properties,even concept that don't yet exist can be
